package itstudio.travel.sortlistview;
...
import itstudio.travel.sortlistview.SideBar.OnTouchingLetterChangedListener;
...
public class ChooseCityActivity extends Activity {
	...
	private void initViews() {
		...
		backView = findViewById(R.id.choose_city_back);
		...
		sortListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				setResult(LeftSlidingMenuFragment.RESULT_OK, intent);  
				finish();  
