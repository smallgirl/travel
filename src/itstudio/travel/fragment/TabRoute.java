...
public class TabRoute extends Activity implements BaiduMap.OnMapClickListener,
	...
	// 在manifest要定义定位的service
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			//获取终点名称
			String endPlace=getIntent().getExtras().getString("endPalce");
			System.out.println("endPlace="+endPlace);
			end.setText(endPlace);
		        ...
		        button.setOnClickListener(new OnClickListener() {
		            ...
		            public void onClick(View v) {
		        		...
		        		PlanNode stNode = PlanNode.withCityNameAndPlaceName("北京", start
		        				.getText().toString());
		        		PlanNode enNode = PlanNode.withCityNameAndPlaceName("北京", end.getText()
		        				.toString());
